...
export const mailboxApi = {
  getAll: (filters?: MailboxFilters) => apiClient.get('/mailboxes', { params: filters }),
  getById: (id: string) =>
    apiClient.get<{ success: boolean; data: { mailbox: Mailbox } }>(`/mailboxes/${id}`),
  create: (payload: CreateMailboxPayload) => apiClient.post('/mailboxes', payload),
