  ...
  return (
    <Box>
      ...
      <Grid container spacing={3}>
        ...
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <StatCard title="Inbound" value={stats?.mail.inbound ?? 0} color="info.main" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <StatCard title="Outbound" value={stats?.mail.outbound ?? 0} color="info.main" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <StatCard title="Delivered" value={stats?.mail.delivered ?? 0} color="success.main" />
        </Grid>
        <Grid size={{ xs: 12, sm: 6, md: 3 }}>
          <StatCard title="Rejected" value={stats?.mail.rejected ?? 0} color="error.main" />
        </Grid>
      </Grid>
    </Box>
  );
