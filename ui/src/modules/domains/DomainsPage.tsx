...
const DomainsPage: React.FC = () => {
  ...
  const handleVerifyDns = async () => {
    ...
    try {
      ...
      showToast(
        data.data.mxVerified ? 'DNS verification successful!' : 'Some records not yet verified',
  ...
  return (
    <Box>
      <AppBreadcrumb items={[{ label: 'Dashboard', href: '/dashboard' }, { label: 'Domains' }]} />
      <Box
        display="flex"
                    ...
                    <TableRow key={domain._id} hover>
                      ...
                      <TableCell align="right">
                        <Tooltip title="DNS Instructions">
                          <IconButton size="small" onClick={() => handleShowDns(domain)}>
