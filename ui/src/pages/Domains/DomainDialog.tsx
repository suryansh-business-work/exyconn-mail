...
const validationSchema = Yup.object({
  name: Yup.string()
    ...
    .matches(/^[a-z0-9][a-z0-9-]*\.[a-z]{2,}$/i, 'Invalid domain format (e.g., example.com)'),
...
export function DomainDialog({ open, domain, onClose, onSubmit }: DomainDialogProps) {
          ...
          <Grid container spacing={2}>
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
              <TextField
                ...
                error={formik.touched.mxPriority && Boolean(formik.errors.mxPriority)}
                helperText={formik.touched.mxPriority && formik.errors.mxPriority}
              />
            </Grid>
            <Grid size={{ xs: 12, sm: 4 }}>
              <TextField
            ...
            <Grid size={{ xs: 12, sm: 4 }}>
              <TextField
                ...
                error={formik.touched.imapPort && Boolean(formik.errors.imapPort)}
