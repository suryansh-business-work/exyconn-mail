                    ...
                    <TableRow key={domain._id}>
                      ...
                      <TableCell>
                        <Tooltip title="View DNS Records">
                          <IconButton size="small" onClick={() => onViewDNS(domain._id)}>
                            <DnsIcon />
                          </IconButton>
                        </Tooltip>
                        <Tooltip title="Verify Domain">
                          <IconButton size="small" onClick={() => onVerify(domain._id)}>
                            <VerifiedIcon />
                          </IconButton>
                        </Tooltip>
                        <Tooltip title="Generate DKIM">
                          <IconButton size="small" onClick={() => onGenerateDKIM(domain._id)}>
                            <KeyIcon />
                          </IconButton>
                        </Tooltip>
                        <Tooltip title="Edit">
                        ...
                        <Tooltip title="Delete">
                          <IconButton size="small" color="error" onClick={() => onDelete(domain._id)}>
                            <DeleteIcon />
                          </IconButton>
                        </Tooltip>
                      </TableCell>
