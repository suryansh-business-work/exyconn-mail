...
export const handleMailEvent = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Failed to log mail event";
...
export const getMailLogs = async (
  ...
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Failed to fetch mail logs";
    res.status(500).json({ success: false, message });
  }
};

export const getMailLogById = async (
  req: Request,
  res: Response,
): Promise<void> => {
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Failed to fetch mail log";
...
export const getMailStats = async (
  ...
  try {
    ...
    const message =
      error instanceof Error ? error.message : "Failed to fetch mail stats";
    res.status(500).json({ success: false, message });
  }
};
