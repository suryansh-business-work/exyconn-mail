...
export const queryMailboxesSchema = z.object({
  ...
  isActive: z
    ...
    .optional(),
  sortBy: z.enum(['email', 'displayName', 'createdAt', 'lastLogin']).optional().default('createdAt'),
...
export type AuthenticateMailboxInput = z.infer<typeof authenticateMailboxSchema>;
